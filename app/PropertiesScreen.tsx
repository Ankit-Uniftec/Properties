...
//       // Fetch shared properties (example: check if userId is inside sharedWith array)
//       const q2 = query(
//         collection(db, "properties"),
//         where("status", "==", "approved"),
...
//         >
//           <Text style={[styles.tabText, selectedTab === "your" && styles.activeTabText]}>
//             Your Properties
//           </Text>
//         </TouchableOpacity>
...
//         {selectedTab === "your" ? "Your Registered Properties" : "Properties Shared with You"}
//       </Text>
...
//   },
//   activeTab: {
//     backgroundColor: "#3572EF", // iOS blue
//   },
//   tabText: {
//     fontSize: 15,
//     color: "white",
